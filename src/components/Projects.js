        ...
        <div className="work_container" id="project">
            ...
            <div className="projects_container">
                ...
                <div key={project.id} className="project">
                    <div className="image">
                        <a href={ project.isLive ? project.url : project.git} target="_blank" rel="noopener noreferrer" onClick={() => handleProjectClick(project.title)}>
            ...
            <div className="projects_container">
                ...
                <div key={project.id} className="project">
                    <div className="image">
                        <a href={project.url} target="_blank" rel="noopener noreferrer" onClick={() => handleProjectClick(project.title)}>
